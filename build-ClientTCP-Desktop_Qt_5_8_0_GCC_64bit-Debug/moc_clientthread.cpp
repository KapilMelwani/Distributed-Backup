...
#include "../ClientTCP/clientthread.h"
...
QT_MOC_LITERAL(1, 13, 7), // "written"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "line"
QT_MOC_LITERAL(4, 27, 3) // "run"

    },
    "ClientThread\0written\0\0line\0run"
};
...
void ClientThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->written((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->run(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientThread::written)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientThread::written(QString _t1)
{
